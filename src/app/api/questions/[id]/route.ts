...
export async function PUT(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const question = await QuestionService.updateQuestion(id, payload!.userId, validated.question_text, validated.options, validated.correct_option_index)
    return okResponse(question, 'Question mise à jour')
  } catch (error) {
